...
export default function RatingBadge({
  ...
  const dims = {
    sm: { num: "text-lg", pad: "px-2 py-1", delta: "text-[10px]" },
    md: { num: "text-3xl", pad: "px-3 py-2", delta: "text-xs" },
    lg: { num: "text-5xl", pad: "px-4 py-3", delta: "text-sm" },
  }[size];
  ...
  return (
    <button
      ...
      className={`group inline-flex items-center gap-2 rounded-md ${dims.pad} ${toneRing} bg-card transition-transform ${
